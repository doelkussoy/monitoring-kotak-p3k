...
if (isset($_POST['simpan_checklist'])) {
  ...
  if ($cek) {
    ...
    $fStr = "apar_id,tahun,bulan,tanggal_cek,label_pengisian,tekanan_pressure,safety_pin,handle,selang_nozzle,dry_chemical,tablulan,bambu_petunjuk,paraf,catatan,users_id";
    ...
    mysqli_query($conn, "INSERT INTO checklist_apar ($fStr) VALUES ($apar_id,$tahun,$bulan,'$tgl',$lp,$tp,$sp,$hd,$sn,$dc,$tb,$bp,'$paraf','$catatan',$uid)");
  }
