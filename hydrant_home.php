        ...
        <div class="d-flex flex-wrap align-items-center gap-2">
          <form method="GET" class="d-flex m-0">
            <div class="input-group input-group-sm">
              ...
              <?php if ($keyword != ''): ?>
                <a href="hydrant_home.php" class="btn btn-secondary"><i class="fa-solid fa-times"></i></a>
              <?php endif; ?>
            </div>
          </form>
          ...
          <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_assoc($listHydrant)): ?>
                <tr>
                  <td><?= $no++ ?></td>
                  <td><span class="hydrant-badge"><?= htmlspecialchars($row['no_kode']) ?></span></td>
                  <td><?= htmlspecialchars($row['nama_sarana']) ?></td>
                  <td><i class="fa-solid fa-location-dot text-danger me-1"></i><?= htmlspecialchars($row['lokasi']) ?>
                  </td>
                  <td>
                    <a href="hydrant_kartu.php?hydrant_id=<?= $row['id'] ?>" class="btn btn-kartu btn-sm me-1">
    ...
    <div class="modal-box">
      ...
      <form method="POST">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="no_kode" placeholder="Contoh: HYD-01" required>
        </div>
        <div class="mb-3">
          <label class="form-label fw-semibold">Nama Sarana/Prasarana</label>
          <input type="text" class="form-control" name="nama_sarana" placeholder="Contoh: Hydrant A" required>
        </div>
        <div class="mb-4">
