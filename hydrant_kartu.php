...
if (isset($_POST['simpan_checklist'])) {
  ...
  if ($cek) {
    ...
    $fStr = "hydrant_id,tahun,bulan,tanggal_cek,valve_handle,hose_coupling_conect,baut_valve_handle,fire_hose,slang_hydrant,nozzle,box_hydrant,paraf,catatan,users_id";
    ...
    mysqli_query($conn, "INSERT INTO checklist_hydrant ($fStr) VALUES ($hydrant_id,$tahun,$bulan,'$tgl',$v1,$v2,$v3,$v4,$v5,$v6,$v7,'$paraf','$catatan',$uid)");
  }
...
<body>
  ...
  <div class="container-fluid" style="margin-top:90px;padding-bottom:30px;max-width:1400px;flex:1">
    ...
    <div class="print-only-header">
      ...
      <div style="width:33%; text-align:center;">Kartu Riwayat Hydrant - <?= htmlspecialchars($hydrantRow['no_kode']) ?></div>
        ...
        <div class="info-box">
          <div class="row g-2">
            <div class="col-12 col-md-4">
              ...
              <div class="info-val"><span class="badge-kode"><?= htmlspecialchars($hydrantRow['no_kode']) ?></span></div>
            </div>
            <div class="col-12 col-md-4">
